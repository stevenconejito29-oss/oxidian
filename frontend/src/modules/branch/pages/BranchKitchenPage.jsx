/**
 * BranchKitchenPage.jsx â€” Vista de Cocina / PreparaciÃ³n
 * DiseÃ±o optimizado para pantallas de cocina: alto contraste,
...
const COL = [
  { id:'pending', label:'ðŸŸ¡ Pendientes', color:'#ca8a04', bg:'#fef9c3', next:'preparing', nextLabel:'â–¶ Iniciar' },
  { id:'preparing', label:'ðŸ”µ Preparando', color:'#2563eb', bg:'#dbeafe', next:'ready', nextLabel:'âœ“ Listo' },
  { id:'ready', label:'ðŸŸ¢ Listos', color:'#16a34a', bg:'#dcfce7', next:null, nextLabel:null },
]
  ...
  return (
    <div style={{
      ...
      <div style={{ borderTop:'1px solid var(--color-border-tertiary)', paddingTop:10, marginBottom:10 }}>
        {items.length === 0
          ? <div style={{fontSize:12,color:'var(--color-text-secondary)',fontStyle:'italic'}}>Sin detalle de Ã­tems</div>
          : items.slice(0, 6).map((item, i) => (
            <div key={i} style={{
              ...
              <div style={{flex:1}}>
                ...
                {item.notes && <div style={{fontSize:12,color:'#dc2626',fontStyle:'italic'}}>âš  {item.notes}</div>}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{flex:1}}>
          <div style={{color:'#f1f5f9',fontWeight:800,fontSize:18}}>ðŸ³ Cocina</div>
          <div style={{color:'#64748b',fontSize:12,marginTop:2}}>
            {branchId || storeId || 'sin scope'} Â· Tiempo real
          </div>
        </div>
